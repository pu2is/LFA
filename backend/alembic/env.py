...
from app.modules.labeling import models as labeling_models  # noqa: F401 - registers Label, FileLabel, TypeLabel, TypeLabelFile, TagKind, TagLabel on Base.metadata
...
# Use the same database URL as the FastAPI app (from .env via Settings),
