"""Tests for POST /paths nested-path registration rules (#38). The advisory
lock guarding concurrent path mutations (#62) now lives in
app.shared.locking (generalized to also gate job mutations in #64) --
see tests/shared/test_locking.py for its exclusivity test."""
